<!DOCTYPE html>
<html>
<body style="background-image:url(ap.jpg) ">
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="logo.png" width="30px" height="30px"><strong>< Appointmentl.ly </strong></a></li>
					<li><a href="locateus.php"><img src="loc.png" width="30px" height="30px" />  Locate Us</a></li>
					<li><a href="#home"><img src="home.png" width="30px" height="30px" /> Home</a></li>
				</ul>
			</div>
			<div class="center">
