...
<body style="background-image:url(neon.jpg)">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="ulogin.php" class="logo"><img src="logo.png" width="30px" height="30px"><strong> Appointment.ly </strong></a></li>
			<li><a href="mgrmenu.php"><img src="home.png" width="30px" height="30px" > Home</a></li>
		</ul>
	</div>
