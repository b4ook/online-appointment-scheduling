...
<body style="background-image:url(images/ap.jpg)">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="ulogin.php" class="logo"><img src="images/logo.png" width="30px" height="30px"><strong> Appointment.ly </strong></a></li>
			<li><a href="cover.php"> <img src="images/home.png" width="30px" height="30px" /> Home</a></li>
		</ul>
	</div>
	<form action="locateus.php" method="post">
	<div class="sucontainer" style="background-image:url(images/neon.jpg)">
		<ul style="background-image:url(images/neon.jpg)">			
