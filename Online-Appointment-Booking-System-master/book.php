...
<body style="background-image:url(images/neon.jpg)">
	<div class="header">
		<ul>
			...
			<li><a href="book.php"><img src="images/iconmonstr-cursor-30-240.png" width="30px" height="30px"/> Book Now</a></li>
			<li><a href="ulogin.php"><img src="images/home.png" width="30px" height="30px"/> Home</a></li>
		</ul>
	</div>
