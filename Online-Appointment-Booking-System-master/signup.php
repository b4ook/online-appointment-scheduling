...
<body style="background-image:url(images/pexels-fwstudio-131634.jpg)">
<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/logo.png" width="30px" height="30px"><strong> Appointment.ly </strong></a></li>
					<li><a href="locateus.php"><img src="images/loc.png" width="30px" height="30px">Locate Us</a></li>
