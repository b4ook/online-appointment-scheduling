<!DOCTYPE html>
<html>
<body style="background-image:url(images/Content-Calendar.jpg)">
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/logo.png" width="50px" height="50px"><strong>Appointment.ly</strong></a></li>
					<li><a href="locateus.php"><img src="images/loc.png" width="50px" height="50px" /> Locate us</a></li>
					<li><a href="#home"><img src="images/home.png" width="50px" height="50px"/> Home</a></li>
				</ul>
			</div>
			<div class="center">
				<h1></h1><br>
				<p style="text-align:center;color:black;font-size:30px;top:35%"></p><br>
				<button onclick="document.getElementById('id01').style.display='block'" style="position:absolute;top:50%;left:47%">Login</button>
